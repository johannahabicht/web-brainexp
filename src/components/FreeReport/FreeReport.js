    ...
    >
      <div key={this.props.questionId}>
        ...
        <form id="create-course-form">
          <input type ="text" inputmode="text" value={this.state.report} onKeyDown={this._handleRefresh} onChange={this.handleChangeReport} name="report" id="report" className="form-control" placeholder="" required />
        </form>
        </div>
      </div>
      <p></p>
