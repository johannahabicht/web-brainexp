  ...
  fetch(`${API_URL}/config_data/create/` + this.state.participant_id + `/` + this.state.prolific_id, {
    ...
    render() {
        ...
        if (this.state.currentInstructionText===1) {
            ...
            <p><span className="bold">Please, have your mobile phone or tablet ready and connected to the Internet before strating.</span></p>
        ...
        mytext = <div className='textbox'> <p></p> <p>Once consented, you will be asked some onboarding questions in the app. Please, answer the questions in order to continue.</p> 
                ...
                <p>Once completed, please go to <span className="bold">Profile</span> at the bottom right corner of your screen, then select <span className="bold">Settings</span> and enter your Handle below.</p>
                <div className="symbolframe">    
            ...
            mytext = <div className='textbox'> <p></p> <p> Finally, verify that the toggle "Participate in the Experiment" is turned "On". If it is not, please, turn it "On" to make sure your participation has been recorded.</p>
                <div className="symbolframe">    
